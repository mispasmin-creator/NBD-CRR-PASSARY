...
const SpecialOfferSection = ({
  ...
  return (
    <div className="bg-white border rounded-lg p-4 shadow-sm">
      <h3 className="text-lg font-medium mb-4 text-center text-sky-600 font-bold">
        Botivate's 10th Anniversary Special Offer
      </h3>
          ...
          quotationData.specialOffers.map((offer, index) => (
            <div key={index} className="flex items-center gap-2">
              <textarea
                ...
                className="flex-1 p-3 border border-gray-300 rounded-md focus:ring-sky-500 focus:border-sky-500"
                rows={2}
