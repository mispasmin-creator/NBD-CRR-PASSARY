            ...
            <div className="py-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    <div className="bg-card rounded-lg shadow-md p-4">
                        <div className="text-sm text-muted-foreground">Total Non-Converted</div>
                        <div className="text-2xl font-bold text-foreground">{leads.length}</div>
                    </div>
                    <div className="bg-card rounded-lg shadow-md p-4">
                        <div className="text-sm text-muted-foreground">Budget Issues</div>
                ...
                <div className="bg-card rounded-lg shadow-md overflow-hidden">
                        ...
                        <table className="w-full">
                            <thead className="bg-muted border-b border-border">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider">Sales Rep</th>
                                    <th className="px-6 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider">Reason</th>
                                    <th className="px-6 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider">Last Contact</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-200">
                                {filteredLeads.map((lead) => (
                                    <tr key={lead.id} className="hover:bg-muted transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="font-medium text-foreground">{lead.leadName}</div>
                                            <div className="text-sm text-muted-foreground">{lead.email}</div>
                                        </td>
                                        <td className="px-6 py-4">
                                            <div className="text-foreground">{lead.contactPerson}</div>
                                            <div className="text-sm text-muted-foreground">{lead.phone}</div>
                                        </td>
                                        <td className="px-6 py-4 text-muted-foreground">{lead.salesRep}</td>
                                        <td className="px-6 py-4">
                    ...
                    {filteredLeads.length === 0 && (
                        <div className="text-center py-12 text-muted-foreground">No non-converted leads found matching your criteria.</div>
                    )}
                </div>
            </div>
        </div>
